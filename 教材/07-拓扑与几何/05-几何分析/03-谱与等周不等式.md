...
**证明**：当 $A, B$ 是坐标方体（boxes）时平凡成立。对一般情形，使用压缩映射 $\Phi_t(x) = (1-t)x_0 + t x$ 将 $A$ 收缩并结合几何测度论中 Brunn 的凹性原理。等号情形由等周不等式的最优性分析得到。
