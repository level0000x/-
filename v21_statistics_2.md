...
> 数理统计在初等统计（V6 Ch 30）和概率论 II（V20）的测度论基础上，建立参数估计、假设检验和贝叶斯方法的严格理论。本卷从估计理论出发，深入讨论 Neyman-Pearson 引理、似然比检验、置信区间、贝叶斯推断、线性模型和多元分析。
...
## 第116章：抽样方法与调查设计（Sampling Methods）
...
## 第117章：时间序列分析（Time Series Analysis）
